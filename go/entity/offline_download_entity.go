...
type OfflineDownloadEntity struct {
	name    string
...
func NewOfflineDownloadEntity(client *core.ListenfreeSDK, entopts map[string]any) *OfflineDownloadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OfflineDownloadEntity) GetName() string { return e.name }
...
func (e *OfflineDownloadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OfflineDownloadEntity) Deleted() bool {
	return e.deleted
}


func (e *OfflineDownloadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOfflineDownloadEntity(e.client, opts)
}

func (e *OfflineDownloadEntity) Data(args ...any) any {
...
func (e *OfflineDownloadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OfflineDownload; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OfflineDownloadEntity) DataTyped(data ...OfflineDownload) OfflineDownload {
	if len(data) > 0 {
		return typedFrom[OfflineDownload](e.Data(asMap(data[0])))
	}
	return typedFrom[OfflineDownload](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OfflineDownload (all fields
// optional at the wire level).
func (e *OfflineDownloadEntity) MatchTyped(match ...OfflineDownload) OfflineDownload {
	if len(match) > 0 {
		return typedFrom[OfflineDownload](e.Match(asMap(match[0])))
	}
	return typedFrom[OfflineDownload](e.Match())
}
...
func (e *OfflineDownloadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OfflineDownloadEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OfflineDownloadEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OfflineDownloadEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OfflineDownloadCreateData and returns an OfflineDownload. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OfflineDownloadEntity) CreateTyped(reqdata OfflineDownloadCreateData, ctrl map[string]any) (OfflineDownload, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OfflineDownload{}, err
	}
	return typedFrom[OfflineDownload](res), nil
}



func (e *OfflineDownloadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OfflineDownloadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OfflineDownloadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
