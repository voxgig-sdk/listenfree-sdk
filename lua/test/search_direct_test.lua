...
describe("SearchDirect", function()
  it("should direct-load-search", function()
    local setup = search_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-search", setup.live and "live" or "unit")
