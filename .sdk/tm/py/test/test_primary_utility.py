...
from projectname_sdk import ListenfreeSDK
from projectname_sdk.core.spec import ListenfreeSpec
from projectname_sdk.core.result import ListenfreeResult
from projectname_sdk.core.response import ListenfreeResponse
from projectname_sdk.core.operation import ListenfreeOperation
from projectname_sdk.core.error import ListenfreeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ListenfreeBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ListenfreeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ListenfreeSDK.test(None, None)
        ...
        class TestInitFeature(ListenfreeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ListenfreeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ListenfreeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ListenfreeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ListenfreeSDK.test(None, setup_opts)
