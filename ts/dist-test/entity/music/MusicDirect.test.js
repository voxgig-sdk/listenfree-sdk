...
(0, node_test_1.describe)('MusicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-music', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-music', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LISTENFREE_TEST_MUSIC_ENTID'];
...
//# sourceMappingURL=MusicDirect.test.js.map