# Listenfree SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ListenfreeError):
        errmsg = err.msg
    ...
    msg = "ListenfreeSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ListenfreeError("", msg, ctx)
