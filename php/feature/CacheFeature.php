...
class ListenfreeCacheFeature extends ListenfreeBaseFeature
{
    ...
    private function _through(ListenfreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
