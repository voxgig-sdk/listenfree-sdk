...
describe("StreamDirect", function()
  it("should direct-load-stream", function()
    local setup = stream_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-stream", setup.live and "live" or "unit")
...
function stream_direct_setup(mockres)
