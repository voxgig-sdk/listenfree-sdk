...
|---|---|---|
| `ts/` | @voxgig-sdk/listenfree-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/listenfree-sdk \
      --repository voxgig-sdk/listenfree-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/listenfree-sdk` shows it, and
`npm trust revoke @voxgig-sdk/listenfree-sdk --id=<id>` removes it.
