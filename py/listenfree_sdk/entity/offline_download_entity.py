...
class OfflineDownloadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OfflineDownloadEntity(self._client, opts)
    ...
    def data_get(self) -> OfflineDownload:
    ...
    def match_get(self) -> OfflineDownload:
    ...
    def create(self, reqdata: OfflineDownloadCreateData, ctrl=None) -> OfflineDownload:
        utility = self._utility
