...
class PlaylistEntity
  ...
  #   as an empty match, so client.Playlist.load works with no args).
  ...
  #
  # @param reqmatch [PlaylistListMatch, Hash, nil] match filter (any subset of
  #   Playlist fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
