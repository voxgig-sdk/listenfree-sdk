...
func (sdk *ListenfreeSDK) OptionsMap() map[string]any {
...
func (sdk *ListenfreeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ListenfreeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ListenfreeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ListenfreeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ListenfreeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ListenfreeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ListenfreeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ListenfreeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ListenfreeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ListenfreeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
