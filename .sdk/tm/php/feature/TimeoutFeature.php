...
// Listenfree SDK timeout feature
...
class ListenfreeTimeoutFeature extends ListenfreeBaseFeature
{
    ...
    private function _with_timeout(ListenfreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ListenfreeContext $_ctx, float $ms): void
    {
        $client = $this->client;
