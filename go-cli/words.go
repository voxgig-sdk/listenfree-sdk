...
func registerSDKWords(r *eng.Registry, client *sdk.ListenfreeSDK) {
...
func runOp(client *sdk.ListenfreeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
