...
class VideoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VideoEntity($this->_client, $opts);
    }

    /**
     * @param Video|array $args Video data (assoc-array) to store.
     */
    ...
    /**
     * @return Video|array The current Video data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Video fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Video fields).
     */
     ...
     * Load a single Video.
     *
     * @param VideoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VideoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Video|array The loaded Video as an assoc-array at the
