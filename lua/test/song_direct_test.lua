...
describe("SongDirect", function()
  it("should direct-load-song", function()
    local setup = song_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-song", setup.live and "live" or "unit")
...
function song_direct_setup(mockres)
