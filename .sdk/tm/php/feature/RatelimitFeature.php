...
// Listenfree SDK ratelimit feature
...
class ListenfreeRatelimitFeature extends ListenfreeBaseFeature
{
    ...
    private function _acquire(ListenfreeContext $ctx): void
    {
    ...
    private function _track(ListenfreeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
