...
class SongEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SongEntity($this->_client, $opts);
    }

    /**
     * @param Song|array $args Song data (assoc-array) to store.
     */
    ...
    /**
     * @return Song|array The current Song data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Song fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Song fields).
     */
     ...
     * Load a single Song.
     *
     * @param SongLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SongLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Song|array The loaded Song as an assoc-array at the
