...
local ListeningRoomEntity = {}
ListeningRoomEntity.__index = ListeningRoomEntity


function ListeningRoomEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListeningRoomEntity)
  self._name = "listening_room"
  self._client = client
...
function ListeningRoomEntity:get_name()
  return self._name
end


function ListeningRoomEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListeningRoomEntity.new(self._client, opts)
end
...
function ListeningRoomEntity:mark_deleted()
  self._deleted = true
end


function ListeningRoomEntity:deleted()
  return true == self._deleted
end


function ListeningRoomEntity:data_set(args)
  if args ~= nil then
...
function ListeningRoomEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListeningRoomEntity:match_set(args)
  if args ~= nil then
...
function ListeningRoomEntity:match_get()
...
function ListeningRoomEntity:stream(action, args, callopts)
...
function ListeningRoomEntity:_run_op(ctx, post_done)
  local utility = self._utility
