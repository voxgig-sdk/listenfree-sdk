...
{
    public function test_direct_load_search(): void
    {
        $setup = search_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-search", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
