-- Listenfree SDK OfflineDownload entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OfflineDownloadEntity = {}
OfflineDownloadEntity.__index = OfflineDownloadEntity


function OfflineDownloadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OfflineDownloadEntity)
  self._name = "offline_download"
  self._client = client
...
function OfflineDownloadEntity:get_name()
  return self._name
end


function OfflineDownloadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OfflineDownloadEntity.new(self._client, opts)
end
...
function OfflineDownloadEntity:mark_deleted()
  self._deleted = true
end


function OfflineDownloadEntity:deleted()
  return true == self._deleted
end


function OfflineDownloadEntity:data_set(args)
  if args ~= nil then
...
function OfflineDownloadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OfflineDownloadEntity:match_set(args)
  if args ~= nil then
...
function OfflineDownloadEntity:match_get()
...
function OfflineDownloadEntity:stream(action, args, callopts)
...
function OfflineDownloadEntity:_run_op(ctx, post_done)
  local utility = self._utility
