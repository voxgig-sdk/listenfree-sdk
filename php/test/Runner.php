...
class ListenfreeTestRunner
{
    ...
    {
        $live = self::getenv('LISTENFREE_TEST_LIVE');
        $override = self::getenv('LISTENFREE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LISTENFREE_TEST_EXPLAIN');
...
class_alias('ListenfreeTestRunner', 'Runner');
class_alias('ListenfreeHelpers', 'Helpers');
