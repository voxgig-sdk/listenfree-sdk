...
class ListenfreeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ListenfreeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ListenfreeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ListenfreeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
