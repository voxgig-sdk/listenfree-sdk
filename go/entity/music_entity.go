...
func NewMusicEntity(client *core.ListenfreeSDK, entopts map[string]any) *MusicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MusicEntity) GetName() string { return e.name }
...
func (e *MusicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MusicEntity) Deleted() bool {
	return e.deleted
}


func (e *MusicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMusicEntity(e.client, opts)
}

func (e *MusicEntity) Data(args ...any) any {
...
func (e *MusicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Music; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MusicEntity) DataTyped(data ...Music) Music {
	if len(data) > 0 {
		return typedFrom[Music](e.Data(asMap(data[0])))
	}
	return typedFrom[Music](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Music (all fields
// optional at the wire level).
func (e *MusicEntity) MatchTyped(match ...Music) Music {
	if len(match) > 0 {
		return typedFrom[Music](e.Match(asMap(match[0])))
	}
	return typedFrom[Music](e.Match())
}
...
func (e *MusicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MusicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MusicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MusicListMatch and returns []Music. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MusicEntity) ListTyped(reqmatch MusicListMatch, ctrl map[string]any) ([]Music, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Music](res), nil
}



func (e *MusicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MusicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MusicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MusicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
