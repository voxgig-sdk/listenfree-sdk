...
AQL-driven CLI and REPL for the Listenfree SDK. Positional arguments are
...
./listenfree-cli load 1 listening_room
./listenfree-cli load '{id:1}' listening_room
