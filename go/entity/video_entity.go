...
func NewVideoEntity(client *core.ListenfreeSDK, entopts map[string]any) *VideoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VideoEntity) GetName() string { return e.name }
...
func (e *VideoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VideoEntity) Deleted() bool {
	return e.deleted
}


func (e *VideoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVideoEntity(e.client, opts)
}

func (e *VideoEntity) Data(args ...any) any {
...
func (e *VideoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Video; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VideoEntity) DataTyped(data ...Video) Video {
	if len(data) > 0 {
		return typedFrom[Video](e.Data(asMap(data[0])))
	}
	return typedFrom[Video](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Video (all fields
// optional at the wire level).
func (e *VideoEntity) MatchTyped(match ...Video) Video {
	if len(match) > 0 {
		return typedFrom[Video](e.Match(asMap(match[0])))
	}
	return typedFrom[Video](e.Match())
}
...
func (e *VideoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VideoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VideoLoadMatch and returns an Video. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VideoEntity) LoadTyped(reqmatch VideoLoadMatch, ctrl map[string]any) (Video, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Video{}, err
	}
	return typedFrom[Video](res), nil
}



func (e *VideoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VideoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VideoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VideoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VideoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
