...
// Listenfree SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ListenfreeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ListenfreeOmni::structfix($now, Struct::undef()))
                        !== json_encode(ListenfreeOmni::structfix($val, Struct::undef()))) {
