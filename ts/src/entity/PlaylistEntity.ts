...
class PlaylistEntity extends ListenfreeEntityBase<Playlist> {
  ...
  async load(this: any, reqmatch?: PlaylistLoadMatch, ctrl?: Control): Promise<PlaylistEntity> {
  ...
  async create(this: any, reqdata?: PlaylistCreateData, ctrl?: Control): Promise<PlaylistEntity> {
  ...
  async update(this: any, reqdata?: PlaylistUpdateData, ctrl?: Control): Promise<PlaylistEntity> {
  ...
  async remove(
    this: any, reqmatch?: PlaylistRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PlaylistEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
