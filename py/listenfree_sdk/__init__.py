...
from listenfree_sdk.utility import register

# Load features
from listenfree_sdk.feature.base_feature import ListenfreeBaseFeature
from listenfree_sdk.features import _has_feature, _make_feature
...
class ListenfreeSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "ListenfreeSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ListenfreeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ListeningRoom(self, data=None) -> "ListeningRoomEntity":
        ...
        from listenfree_sdk.entity.listening_room_entity import ListeningRoomEntity
    ...
    def Music(self, data=None) -> "MusicEntity":
        ...
        from listenfree_sdk.entity.music_entity import MusicEntity
    ...
    def OfflineDownload(self, data=None) -> "OfflineDownloadEntity":
        ...
        from listenfree_sdk.entity.offline_download_entity import OfflineDownloadEntity
