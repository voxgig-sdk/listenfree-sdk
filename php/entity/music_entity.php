...
class MusicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MusicEntity($this->_client, $opts);
    }

    /**
     * @param Music|array $args Music data (assoc-array) to store.
     */
    ...
    /**
     * @return Music|array The current Music data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Music fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Music fields).
     */
    ...
    /**
     * List Music items matching the given filter.
     *
     * @param MusicListMatch|array|null $reqmatch Match filter (any subset
     *   of Music fields) as an assoc-array; MusicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Music[]|array A list of Music items as assoc-arrays at
