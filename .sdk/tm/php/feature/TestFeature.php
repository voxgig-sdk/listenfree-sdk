...
// Listenfree SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ListenfreeTestFeature extends ListenfreeBaseFeature
{
    ...
    public function init(ListenfreeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ListenfreeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ListenfreeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ListenfreeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ListenfreeContext $ctx, $op, $args): array
    {
