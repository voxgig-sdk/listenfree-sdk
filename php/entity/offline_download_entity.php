...
class OfflineDownloadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OfflineDownloadEntity($this->_client, $opts);
    }

    /**
     * @param OfflineDownload|array $args OfflineDownload data (assoc-array) to store.
     */
    ...
    /**
     * @return OfflineDownload|array The current OfflineDownload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OfflineDownload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OfflineDownload fields).
     */
    ...
    /**
     * Create a new OfflineDownload.
     *
     * @param OfflineDownloadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OfflineDownloadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfflineDownload|array The created OfflineDownload as an assoc-array at the
