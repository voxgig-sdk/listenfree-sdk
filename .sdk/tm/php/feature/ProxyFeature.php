...
class ListenfreeProxyFeature extends ListenfreeBaseFeature
{
    ...
    public function init(ListenfreeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ListenfreeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
