...
class ListenfreeRbacFeature extends ListenfreeBaseFeature
{
    ...
    private function _required(ListenfreeContext $ctx): ?string
    {
    ...
    private function _reject(ListenfreeContext $ctx, string $required): void
    {
    ...
    private function _track(ListenfreeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
