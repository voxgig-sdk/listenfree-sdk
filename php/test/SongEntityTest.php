...
class SongEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LISTENFREE_TEST_SONG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function song_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LISTENFREE_TEST_SONG_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LISTENFREE_TEST_SONG_ENTID"]);
