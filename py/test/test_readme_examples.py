# Listenfree SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ListenfreeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ListenfreeSDK(...) and ListenfreeSDK.test(...) become
#      ListenfreeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "listenfree_sdk"
_SDK_CLASS = "ListenfreeSDK"
