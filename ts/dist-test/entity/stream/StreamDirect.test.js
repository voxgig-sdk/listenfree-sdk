...
(0, node_test_1.describe)('StreamDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-stream', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stream', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LISTENFREE_TEST_STREAM_ENTID'];
...
//# sourceMappingURL=StreamDirect.test.js.map