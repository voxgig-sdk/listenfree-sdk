...
(0, node_test_1.describe)('VideoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-video', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-video', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["song_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LISTENFREE_TEST_VIDEO_ENTID'];
...
//# sourceMappingURL=VideoDirect.test.js.map