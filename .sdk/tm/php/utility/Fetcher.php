...
// Listenfree SDK utility: fetcher

class ListenfreeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ListenfreeSDK/1.0)';
    ...
    public static function call(ListenfreeContext $ctx, string $fullurl, array $fetchdef): array
    {
