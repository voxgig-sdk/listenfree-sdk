...
describe("MusicDirect", function()
  it("should direct-list-music", function()
    local setup = music_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-music", setup.live and "live" or "unit")
...
function music_direct_setup(mockres)
