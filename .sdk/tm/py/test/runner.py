...
class ListenfreeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ListenfreeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ListenfreeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ListenfreeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
