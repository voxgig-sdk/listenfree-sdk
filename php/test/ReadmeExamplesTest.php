...
// Listenfree SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ListenfreeSDK::test)
...
{
    private const SDK_CLASS = 'ListenfreeSDK';
    ...
    private const SDK_BASE = 'listenfree_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../listenfree_sdk.php';
