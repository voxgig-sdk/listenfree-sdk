...
exports.SDK = exports.ListenfreeSDK = exports.ListenfreeEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const ListeningRoomEntity_1 = require("./entity/ListeningRoomEntity");
const MusicEntity_1 = require("./entity/MusicEntity");
const OfflineDownloadEntity_1 = require("./entity/OfflineDownloadEntity");
const PlaylistEntity_1 = require("./entity/PlaylistEntity");
const SearchEntity_1 = require("./entity/SearchEntity");
const SongEntity_1 = require("./entity/SongEntity");
const StreamEntity_1 = require("./entity/StreamEntity");
const VideoEntity_1 = require("./entity/VideoEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const ListenfreeEntityBase_1 = require("./ListenfreeEntityBase");
Object.defineProperty(exports, "ListenfreeEntityBase", { enumerable: true, get: function () { return ListenfreeEntityBase_1.ListenfreeEntityBase; } });
...
class ListenfreeSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('ListenfreeSDK: graphql: ' +
    ...
    ListeningRoom(entopts) {
        const self = this;
        return new ListeningRoomEntity_1.ListeningRoomEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    OfflineDownload(entopts) {
        const self = this;
        return new OfflineDownloadEntity_1.OfflineDownloadEntity(self, entopts);
    }
    ...
    Song(entopts) {
        const self = this;
        return new SongEntity_1.SongEntity(self, entopts);
    }
    ...
    Stream(entopts) {
        const self = this;
        return new StreamEntity_1.StreamEntity(self, entopts);
    }
...
exports.ListenfreeSDK = ListenfreeSDK;
const SDK = ListenfreeSDK;
exports.SDK = SDK;
//# sourceMappingURL=ListenfreeSDK.js.map