...
const testSeed = `map[string]any{"entity": map[string]any{"listening_room": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "music": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "offline_download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "playlist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "song": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stream": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "video": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
