...
class TestSearchDirect:
    ...
    def test_should_direct_load_search(self):
        setup = _search_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-search", "live" if setup["live"] else "unit")
        if _skip:
