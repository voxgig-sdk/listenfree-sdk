...
class MusicEntity
  ...
  # @return [Music, Hash] the current Music data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Music fields)
  def match_get
  ...
  #
  # @param reqmatch [MusicListMatch, Hash, nil] match filter (any subset of
  #   Music fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Music>, Array] the matching Music items; raises ListenfreeError on failure
