...
local SDK_MODULE = "listenfree_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["listening_room"] = { ["test01"] = { id = "test01" } }, ["music"] = { ["test01"] = { id = "test01" } }, ["offline_download"] = { ["test01"] = { id = "test01" } }, ["playlist"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["song"] = { ["test01"] = { id = "test01" } }, ["stream"] = { ["test01"] = { id = "test01" } }, ["video"] = { ["test01"] = { id = "test01" } } } }'
