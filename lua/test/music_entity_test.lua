...
describe("MusicEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Music(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Music(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LISTENFREE_TEST_MUSIC_ENTID JSON to run live")
      return
    end
...
function music_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LISTENFREE_TEST_MUSIC_ENTID")
