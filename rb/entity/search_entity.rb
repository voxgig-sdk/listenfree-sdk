...
class SearchEntity
  ...
  # Load a single Search.
  #
  # @param reqmatch [SearchLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Search.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Search, Hash] the loaded Search; raises ListenfreeError on failure
