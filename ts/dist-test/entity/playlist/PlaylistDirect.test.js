...
(0, node_test_1.describe)('PlaylistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-playlist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-playlist', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-playlist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-playlist', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LISTENFREE_TEST_PLAYLIST_ENTID'];
...
//# sourceMappingURL=PlaylistDirect.test.js.map