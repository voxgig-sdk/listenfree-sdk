...
class StreamDirectTest extends TestCase
{
    public function test_direct_load_stream(): void
    {
        $setup = stream_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-stream", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
