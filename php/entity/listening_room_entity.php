...
// Listenfree SDK ListeningRoom entity
...
class ListeningRoomEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListeningRoomEntity($this->_client, $opts);
    }

    /**
     * @param ListeningRoom|array $args ListeningRoom data (assoc-array) to store.
     */
    ...
    /**
     * @return ListeningRoom|array The current ListeningRoom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListeningRoom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListeningRoom fields).
     */
     ...
     *
     * @param ListeningRoomLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ListeningRoomLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListeningRoom|array The loaded ListeningRoom as an assoc-array at the
     ...
     *
     * @param ListeningRoomListMatch|array|null $reqmatch Match filter (any subset
     *   of ListeningRoom fields) as an assoc-array; ListeningRoomListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListeningRoom[]|array A list of ListeningRoom items as assoc-arrays at
     ...
     *
     * @param ListeningRoomCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ListeningRoomCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListeningRoom|array The created ListeningRoom as an assoc-array at the
     *   SDK boundary; throws ListenfreeError on failure (item-5 convention).
     */
