...
describe("SongEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LISTENFREE_TEST_SONG_ENTID JSON to run live")
      return
    end
...
function song_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LISTENFREE_TEST_SONG_ENTID")
