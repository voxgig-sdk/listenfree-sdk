...
module ListenfreeTestRunner
  ...
  def self.env_override(m)
    live = getenv("LISTENFREE_TEST_LIVE")
    override = getenv("LISTENFREE_TEST_OVERRIDE")
    ...
    explain = getenv("LISTENFREE_TEST_EXPLAIN")
    m["LISTENFREE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ListenfreeTestRunner
Helpers = ListenfreeHelpers
Vs = VoxgigStruct
