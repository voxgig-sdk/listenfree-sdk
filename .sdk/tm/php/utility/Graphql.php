...
// Listenfree SDK utility: graphql
//
...
class ListenfreeGraphql
{
    ...
    // equivalent.
    public static function body(ListenfreeContext $ctx): mixed
    {
    ...
    public static function errors(ListenfreeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
