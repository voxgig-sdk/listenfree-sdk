...
// Listenfree SDK telemetry feature
...
class ListenfreeTelemetryFeature extends ListenfreeBaseFeature
{
    ...
    private function _close(ListenfreeContext $ctx, bool $ok): void
    {
