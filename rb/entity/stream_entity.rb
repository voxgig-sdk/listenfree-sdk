...
class StreamEntity
  ...
  # @return [Stream, Hash] the current Stream data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Stream fields)
  def match_get
  ...
  #
  # @param reqmatch [StreamLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Stream.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Stream, Hash] the loaded Stream; raises ListenfreeError on failure
