...
// Listenfree SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ListenfreeTransformResponse
{
    public static function call(ListenfreeContext $ctx): mixed
    {
        ...
        $transform = ListenfreeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
