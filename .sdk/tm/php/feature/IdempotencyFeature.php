...
// Listenfree SDK idempotency feature
...
class ListenfreeIdempotencyFeature extends ListenfreeBaseFeature
{
    ...
    private function _mutating(ListenfreeContext $ctx): bool
    {
