...
function envOverride(m) {
    if ('TRUE' === process.env.LISTENFREE_TEST_LIVE ||
        'TRUE' === process.env.LISTENFREE_TEST_OVERRIDE) {
    ...
    m.LISTENFREE_TEST_EXPLAIN = process.env.LISTENFREE_TEST_EXPLAIN || m.LISTENFREE_TEST_EXPLAIN;
    return m;
}
