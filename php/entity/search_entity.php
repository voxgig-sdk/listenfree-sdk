...
class SearchEntity
{
     ...
     *
     * @param SearchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SearchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Search|array The loaded Search as an assoc-array at the
