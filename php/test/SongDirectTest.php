...
class SongDirectTest extends TestCase
{
    public function test_direct_load_song(): void
    {
        $setup = song_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-song", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
