...
(0, node_test_1.describe)('PlaylistEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != playlist_ref01_data.id);
        // LIST
        const playlist_ref01_match = {};
        const playlist_ref01_list = (await playlist_ref01_ent.list(playlist_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(playlist_ref01_list, { id: playlist_ref01_data.id })));
        // UPDATE
        const playlist_ref01_data_up0 = {};
        ...
        (0, node_assert_1.default)(playlist_ref01_resdata_up0.id === playlist_ref01_data_up0.id);
        (0, node_assert_1.default)(playlist_ref01_resdata_up0[playlist_ref01_markdef_up0.name] === playlist_ref01_markdef_up0.value);
        // LOAD
        ...
        // REMOVE
        const playlist_ref01_match_rm0 = { id: playlist_ref01_data.id };
        await playlist_ref01_ent.remove(playlist_ref01_match_rm0);
        // LIST
        const playlist_ref01_match_rt0 = {};
        const playlist_ref01_list_rt0 = (await playlist_ref01_ent.list(playlist_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(playlist_ref01_list_rt0, { id: playlist_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['playlist01', 'playlist02', 'playlist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
