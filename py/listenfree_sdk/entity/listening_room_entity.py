...
class ListeningRoomEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListeningRoomEntity(self._client, opts)
    ...
    def data_get(self) -> ListeningRoom:
    ...
    def match_get(self) -> ListeningRoom:
    ...
    def create(self, reqdata: ListeningRoomCreateData, ctrl=None) -> ListeningRoom:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
