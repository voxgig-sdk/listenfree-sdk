...
func NewSongEntity(client *core.ListenfreeSDK, entopts map[string]any) *SongEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SongEntity) GetName() string { return e.name }
...
func (e *SongEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SongEntity) Deleted() bool {
	return e.deleted
}


func (e *SongEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSongEntity(e.client, opts)
}

func (e *SongEntity) Data(args ...any) any {
...
func (e *SongEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SongEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SongEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SongEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SongEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SongEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SongEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
