...
(0, node_test_1.describe)('ListeningRoomDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ListenfreeSDK({
    ...
    (0, node_test_1.test)('direct-load-listening_room', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-listening_room', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-listening_room', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-listening_room', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.LISTENFREE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ListenfreeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.LISTENFREE_APIKEY,
        }));
        let idmap = env['LISTENFREE_TEST_LISTENING_ROOM_ENTID'];
    ...
    const client = new __1.ListenfreeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ListeningRoomDirect.test.js.map