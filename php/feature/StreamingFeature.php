...
// Listenfree SDK streaming feature
...
class ListenfreeStreamingFeature extends ListenfreeBaseFeature
{
    ...
    private function _iterate(ListenfreeResult $result): \Generator
    {
    ...
    private function _streamable(ListenfreeContext $ctx): bool
    {
