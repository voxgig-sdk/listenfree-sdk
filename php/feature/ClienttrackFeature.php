...
// Listenfree SDK clienttrack feature
...
class ListenfreeClienttrackFeature extends ListenfreeBaseFeature
{
    ...
    public function PostConstruct(ListenfreeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Listenfree-SDK';
