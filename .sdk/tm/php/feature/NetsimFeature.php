...
class ListenfreeNetsimFeature extends ListenfreeBaseFeature
{
    ...
    private function _simulate(ListenfreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ListenfreeContext $ctx, array $applied): void
    {
        $client = $this->client;
