...
{
    private static function utility(): ListenfreeUtility
    {
        return new ListenfreeUtility();
    }
    ...
    private static function ctx(array $over = []): ListenfreeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ListenfreeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ListenfreeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ListenfreeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ListenfreeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ListenfreeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ListenfreeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ListenfreeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ListenfreeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ListenfreeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ListenfreeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ListenfreeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ListenfreeResponse([]),
            'result' => new ListenfreeResult([]),
        ]);
        [, $err] = ListenfreeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ListenfreeSpec([]),
            'response' => null,
            'result' => new ListenfreeResult([]),
        ]);
        [, $err] = ListenfreeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ListenfreeSpec(['step' => 's']),
            'response' => new ListenfreeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ListenfreeResult([]),
        ]);
        [, $err] = ListenfreeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ListenfreeSpec(['step' => 's']),
            'response' => new ListenfreeResponse(self::resp(200, ['v' => 1])),
            'result' => new ListenfreeResult([]),
        ]);
        [, $err] = ListenfreeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ListenfreeSpec(['step' => 's']),
            'response' => new ListenfreeResponse(self::resp(200, ['v' => 2])),
            'result' => new ListenfreeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ListenfreeMakeResponse::call($ctx);
    ...
    {
        $preset = new ListenfreeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ListenfreeSpec([]),
            'response' => new ListenfreeResponse([]),
            'result' => new ListenfreeResult([]),
        ...
        [$got, $err] = ListenfreeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ListenfreeResult([])]);
        [, $err] = ListenfreeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ListenfreeSpec([]), 'result' => null]);
        [, $err] = ListenfreeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ListenfreeSpec(['step' => 's']),
            'result' => new ListenfreeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ListenfreeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ListenfreeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ListenfreeSpec(['step' => 's']),
            'result' => new ListenfreeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ListenfreeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ListenfreeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ListenfreeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ListenfreeSpec([]),
            'result' => new ListenfreeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ListenfreeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ListenfreeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ListenfreeError('boom', 'boom');
        $utility->fetcher = function (ListenfreeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ListenfreeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ListenfreeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ListenfreeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ListenfreeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ListenfreeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ListenfreeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ListenfreeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ListenfreeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ListenfreeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ListenfreeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ListenfreeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ListenfreeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ListenfreeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ListenfreeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ListenfreeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ListenfreeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ListenfreeResult(['ok' => false])]);
        $this->expectException(ListenfreeError::class);
        ListenfreeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ListenfreeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ListenfreeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ListenfreeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ListenfreeBaseFeature();
        $b = new ListenfreeBaseFeature();
        ListenfreeFeatureAdd::call($ctx, $a);
        ListenfreeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ListenfreeBaseFeature
    {
        $f = new ListenfreeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ListenfreeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ListenfreeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ListenfreeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ListenfreePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ListenfreePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ListenfreeResponse(['headers' => null]),
            'result' => new ListenfreeResult([]),
        ]);
        ListenfreeResultHeaders::call($ctx);
