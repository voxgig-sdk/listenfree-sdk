...
(0, node_test_1.describe)('SongDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-song', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-song', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LISTENFREE_TEST_SONG_ENTID'];
...
//# sourceMappingURL=SongDirect.test.js.map