// Command Listenfree-mcp is an MCP server exposing the Listenfree
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Listenfree_list  — list records of an entity
//	Listenfree_load  — load a single record of an entity
//
