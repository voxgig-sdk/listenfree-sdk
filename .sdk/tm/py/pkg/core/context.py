...
from projectname_sdk.core.control import ListenfreeControl
...
class ListenfreeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ListenfreeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ListenfreeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ListenfreeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ListenfreeError(code, msg, self)
