...
class MusicDirectTest extends TestCase
{
    public function test_direct_list_music(): void
    {
        $setup = music_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-music", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
